...
> *Note:* After *neongo*, the possessive pronoun + verb pattern is common: *neongo 'eku hela'ia* (although my being-tired, i.e., although I am tired). This is the same verbal noun construction used with *'i he* above and throughout the possessive system.
...
|---|---|---|
| *kapau* | if (condition first) | *kapau* + condition, result |
| *'o kapau* | if (condition second) | result, *'o kapau* + condition |
| *lolotonga* | while, during | clause + *lolotonga* + clause |
| *kae'oua ke* | until | clause + *kae'oua ke* + event |
| *kae'oua kuo* | until (completed) | clause + *kae'oua kuo* + completion |
| *'i he* + verbal noun | when | *'i he* + poss. + verb, *pea* + clause |
| *neongo* | although | *neongo* + concession, (*ka*) + result |
| *'ilonga* | whoever, whatever | *'ilonga* (+ *ia*) + clause, main clause |
| *kae kehe* | nevertheless | clause, *kae kehe*, contrasting clause |
| *kehe ke* | provided that | clause, *kehe ke* + required condition |
| *faifai* | by and by | *pea faifai pea* + verb |
...
|--------|----------|---------|
| *kapau* | conjunction | if |
| *'o kapau* | conjunction phrase | if (when condition comes second) |
| *kae'oua ke* | conjunction phrase | until |
| *neongo* | conjunction | although, even though |
| *hilí* | conjunction | after |
...
1. If you come, I will sing.
2. I was reading while she was sleeping.
3. I will work until they come back.
4. When he finished eating, he slept.
