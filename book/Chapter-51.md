...
> *Note:* The compound *siokita* means "selfish" (literally "look after oneself"). Its opposite is *ta'esiokita*, "unselfish," using the negative prefix *ta'e-* you learned previously.
...
| Form | Class | Meaning |
|---|---|---|
| *'ete* | 'e-class preposed definite | one's (things one controls) |
| *hoto* | ho-class preposed definite | one's (things that characterise one) |
| *ha'ate* | 'e-class preposed indefinite | one's (indefinite, 'e-class) |
| *hato* | ho-class preposed indefinite | one's (indefinite, ho-class) |
...
> *Note:* This is not an error or a special exception. It reflects a fundamental difference in how Tongan conceptualises group actions. Where English focuses on who is doing the action ("I stayed"), Tongan focuses on who is in the situation ("we-two were staying together").
...
|--------|----------|---------|
| *te* | impersonal pronoun | one (indefinite); also humble "I" |
| *kita* | impersonal postposed pronoun | oneself |
| *'ete* | impersonal possessive ('e-class) | one's |
| *hoto* | impersonal possessive (ho-class) | one's |
| *ha'ate* | impersonal indefinite possessive ('e-class) | a ... of one's |
| *hato* | impersonal indefinite possessive (ho-class) | a ... of one's |
| *'a'ata* | impersonal postposed possessive ('e-class) | of one's |
...
4. *Na'á ma lea mo ia.*
5. *'Oku totonu ke tauhi 'e te hoto fāmilí.*
