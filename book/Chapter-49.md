...
| Base verb | *fe-...-'aki* form | Meaning |
|---|---|---|
| *'ofa* (love) | *fe'ofa'aki* | to love one another |
| *tokoni* (help) | *fetokoni'aki* | to help each other |
| *lea* (speak) | *felea'aki* | to speak to each other |
| *tohi* (write) | *fetohi'aki* | to write to each other |
| *talanoa* (talk) | *fetalanoa'aki* | to talk to one another |
| *tali* (wait) | *fetali'aki* | to wait for each other |
| *'ita* (be angry) | *fe'ita'aki* | to be angry with each other |

The reciprocative sense (back and forth) appears with movement verbs:

| Base verb | *fe-...-'aki* form | Meaning |
|---|---|---|
| *'alu* (go) | *fe'alu'aki* | to go back and forth |
| *'ave* (carry) | *fe'āveaki* | to carry back and forth |
| *folau* (voyage) | *fefolau'aki* | to travel back and forth |
...
| Base verb | *fe-* form | Meaning |
|---|---|---|
| *lele* (run) | *felelei* | to run together (plural) |
| *kata* (laugh) | *fekata'i* | to laugh together |
| *tangi* (weep) | *fetāngihi* | to weep together |
| *hū* (enter) | *fehuufi* | to enter together |

**Reciprocal verbs** with these suffixes describe mutual states:

| Base | *fe-* form | Meaning |
|---|---|---|
| *'ofo'ofa* (friendly) | *fe'ofo'ofani* | to be friendly with one another |
| *'ite'ita* (ill-will) | *fe'ite'itani* | to harbour mutual ill-will |
| *loto* (mind, will) | *felotoi* | to agree with each other |

Some *fe-* verbs have no suffix at all. These are common enough to learn as vocabulary:

| Base | *fe-* form | Meaning |
|---|---|---|
| *tongi/totongi* (pay) | *fetongi* | to replace, take the place of |
| *kumi* (seek) | *fekumi* | to search together |
| *tuku* (put) | *fetuku* | to carry from one place to another |
...
| Base verb | *ma-/mo-/mā-* form | Meaning |
|---|---|---|
| *hae* (tear) | *mahae* | to be torn |
| *kohi* (scratch) | *makohi* | to be scratched |
| *to'o* (take off) | *mato'o* | to come off |
| *hiki* (lift) | *mahiki* | to be slightly raised |
| *fusi* (pull) | *mafusi* | to be pulled slightly out of position |
| *vete* (take apart) | *movete* | to come to pieces |
| *vae* (divide) | *māvae* | to be separated, parted |
...
| Base verb | *mo'u-...-a* form | Meaning |
|---|---|---|
| *mohe* (sleep) | *mo'umohea* | to oversleep |
| *tu'u* (stand) | *mo'utu'ua* | to remain standing too long |
| *'ā* (be awake) | *mo'u'ā* | to stay awake too long |
| *nofo* (stay) | *mo'unofoa* | to overstay |
| *sio* (look, watch) | *mo'usioa* | to stay too long watching |
...
| Base verb | *kaungā-* form | Meaning |
|---|---|---|
| *ngāue* (work) | *kaungāngāue* | to work together, fellow-worker(s) |
| *lotu* (worship) | *kaungālotu* | to worship together, fellow-worshipper(s) |
| *ako* (study) | *kaungā ako* | fellow student(s) |
| *mamahi* (suffer) | *kaungā mamahi* | fellow sufferer(s) |

**With nouns:**

| Base noun | *kaungā-* form | Meaning |
|---|---|---|
...
|--------|----------|---------|
| *fe-...-'aki* | reciprocal prefix+suffix | each other, one another |
| *fe-* | prefix (reciprocal) | mutual action |
| *ma-* | prefix (potential) | able to be (discovered by trial) |
| *ma-/mo-/mā-* | prefix (resultative) | in a state resulting from |
| *mo'u-* | prefix | continuing or overdoing |
| *kaungā-* | prefix | fellow, together |

**New vocabulary** (memorize these meanings):

| Tongan | Type | English |
|--------|------|---------|
| *fe'ofa'aki* | verb | love one another |
| *fetokoni'aki* | verb | help one another |
...
1. *'ofa* (love) → _____ (meaning: _____)
2. *tokoni* (help) → _____ (meaning: _____)
3. *lea* (speak) → _____ (meaning: _____)
4. *talanoa* (talk) → _____ (meaning: _____)
5. *'alu* (go) → _____ (meaning: _____)
6. *tohi* (write) → _____ (meaning: _____)
...
1. Na'e ___ 'a e falá. (The mat was torn.) [prefix: ___]
2. Na'a nau ___'aki 'i he efiafí. (They talked to one another in the evening.) [prefix + suffix: ___]
3. Kuo ___ 'a Mele. (Mele has overslept.) [prefix: ___]
4. Ko hoku ___ 'a Sēmisi. (Sēmisi is my fellow-worker.) [prefix: ___]
5. 'Okú na ___ ma'u pē. (They two communicate constantly.) [verb with prefix: ___]
