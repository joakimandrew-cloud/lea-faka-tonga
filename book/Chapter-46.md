...
|---|---|
| *ki Vava'u* (to Vava'u) | *ki he motú* (to the island) |
| *kia Mele* (to Mele) | *ki he fefiné* (to the woman) |
...
Many nouns can be used both ways. The word *tahi* (sea) can be self-defining (*ki tahi*, to sea, referring to the sea in general) or common (*ki he tahí*, to the sea, referring to a specific body of water).
...
|---|---|---|
| *'uta* | inland, interior | *ki 'uta* (to the interior) |
| *ngoue* | garden | *ki ngoue* (to the garden) |
| *loto* | inside | *'i loto* (inside) |
...
> *Note:* With *sai'ia*, the *'i* before *he* drops in speech, as it does in other constructions: *'Oku ou sai'ia he me'akaí* rather than *'Oku ou sai'ia 'i he me'akaí*.
...
|---|---|---|---|
| Personal (names of people) | No | No | *'ia*, *kia*, *meia* |
| Local (names of places, quasi-place nouns) | No | No | *'i*, *ki*, *mei* |
| Common (everything else) | Yes | Yes | *'i he*, *ki he*, *mei he* |
...
|---|---|---|
| *fo'i* | single, round, complete | *fo'i moli* (an orange) |
| *la'i* | long, thin, flat | *la'i pepa* (a sheet of paper) |
...
|--------|----------|---------|
| *la'i* | classifier | flat objects (from *lau'i*, the leaf of) |

**New vocabulary** (memorize these meanings):

| Tongan | Type | English |
|--------|------|---------|
| *'uta* | noun (quasi-local) | inland, interior |
...
1. Na'á ku 'alu ___ Fisi. (ki)
2. Na'á ku lea ___ Lupe. (ki)
3. Na'á ne nofo ___ Sēmisi. ('i)
4. Te mau folau ___ Ha'apai. (mei)
5. Na'á ne tokoni ___ faiakó. (ki)
6. Te nau foki ___ Siaosi. (mei)
