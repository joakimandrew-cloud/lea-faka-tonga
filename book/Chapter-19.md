...
|---|---|---|
| Intransitive (no object) | *'a* | *Na'e lea **'a** Sione.* |
| Transitive (has an object) | *'e* | *Na'e lau **'e** Sione 'a e tohí.* |
...
::: {.examples}
*Na'e kai 'e Sione 'a e mā.* Sione ate the bread.
:::
...
|---|---|
| *Na'e kai ma 'a Sione.* | *Na'e kai 'e Sione 'a e mā.* |
...
::: {.examples}
*Na'á ku inu vai.* I drank water. (Intransitive compound.)

*Na'á ku inu 'a e vaí.* I drank the water. (Transitive: definite object.)
:::
...
> *Note:* Tongan also has intransitive verbs that translate as passive in English even though they are not structurally passive: *ngalo* (to be forgotten), *motu* (to be severed), *melemo* (to be drowned). These are simply intransitive verbs that describe a state the subject is in.
...
*'Okú ne manatu'i lelei koe.* He remembers you well.
:::
...
1. Make passive (drop the *'e* phrase): *Na'e kuki 'e Tēvita 'a e mā.* → ___
2. Make passive: *Kuo faka'osi 'e Sēmisi 'a e lesoní.* → ___
3. Fill in the required pronoun: *Kuo lau 'e Lupe 'a e tohí? 'Io, kuó \_\_\_ lau 'a e tohí.*
4. Replace the noun object with the postposed pronoun *ia* (drop *'a*): *Té u kumi 'a Sione.* → ___
5. Replace the noun object with the postposed pronoun *kinautolu*: *Kuo ui 'e Mele 'a e fānau.* → ___
...
::: {.examples}
*Té u fai ia 'e au.* I will do it myself.

*Na'á ku faka'osi 'e au 'a e ngāué.* I finished the work myself.
...
::: {.examples}
*Na'e 'ikai ke 'alu 'a Sione.* Sione did not go. (Intransitive.)

*Na'e 'ikai ke fai 'e Sione 'a e ngāué.* Sione did not do the work. (Transitive.)
:::
