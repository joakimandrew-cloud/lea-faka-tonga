...
|---|---|---|
| *nofo* (stay) | *nofo'anga* | dwelling-place |
| *ako* (study) | *ako'anga* | school |
| *ngāue* (work) | *ngāue'anga* | workplace |
| *kai* (eat) | *kai'anga* | eating-place |
| *mohe* (sleep) | *mohe'anga* | sleeping-place |
| *fiefia* (happy) | *fiefia'anga* | source of happiness |
| *tuku* (put) | *tuku'anga* | storage place |
...
| Verb | + *-nga* | Meaning |
|---|---|---|
| *vahe* (divide) | *vāhenga* | portion, division |
| *toe* (remain) | *toenga* | remainder |
| *fou* (go by a route) | *founga* | route, method |
| *ako* (learn) | *ākonga* | disciple, student |

> *Note:* Some words formed with *-nga* involve a vowel change in the base word. *Ako* becomes *ākonga* (disciple) with a lengthened first vowel. *Fotu* (to appear) becomes *fōtunga* (appearance) with a long *ō*. These are irregular and must be learned individually.
...
|---|---|---|
| *efu* (dust) | *efua* | dusty |
| *niu* (coconut) | *niua* | abounding in coconut trees |
| *lango* (fly) | *langoa* | infested with flies |
...
|---|---|---|---|
| *tonu* (right, just) | *-hia* | *tonuhia* | innocent, not guilty |
| *hala* (to err) | *-ia* | *halaia* | guilty |
| *'uha* (rain) | *-ina* | *'uheina* | caught in the rain |
...
| Noun | + *-'ia* | Meaning |
|---|---|---|
| *koloa* (wealth) | *koloa'ia* | wealthy |
| *kakai* (people) | *kakai'ia* | populated |
| *kumā* (rat) | *kumā'ia* | infested with rats |
| *mamahi* (pain) | *mamahi'ia* | in pain |
| *pupuha* (sweat) | *pupuha'ia* | covered in sweat |
...
|---|---|---|
| *mata 'o e hele* | *mata'i hele* | knife-blade |
| *'ulu 'o e ika* | *'ulu'i ika* | fish-head |
...
| *tonuhia* | adjective | justified, righteous |
| *halaia* | adjective | guilty |
| *mata'i hele* | noun | blade of a knife |
| *'ulu'i ika* | noun | head of a fish |
| *tefito'i me'a* | noun | main thing |
...
1. *nofo* + *-'anga* = _____ (meaning: _____)
2. *mohe* + *-nga* = _____ (meaning: _____)
3. *koloa* + *-'ia* = _____ (meaning: _____)
4. *fai* + *-'aki* = _____ (meaning: _____)
5. *mata* + *-'i* + *hele* = _____ (meaning: _____)
6. *fai* + *-ngata'a* = _____ (meaning: _____)
7. *ma'u* + *-ngofua* = _____ (meaning: _____)
8. *efu* + *-a* = _____ (meaning: _____)
...
1. *Ko e mohe\_\_\_ 'o Siale 'oku fo'ou.* (Siale's ___ is new.)
2. *Ko e nofo\_\_\_ ko ení 'oku lahi.* (This dwelling-___ is big.)
3. *Ko e tu'u\_\_\_ 'o e faiakó 'oku mālohi.* (The teacher's ___ is strong.)
4. *Ko e mohe\_\_\_ 'o e fānau 'oku 'i lalo.* (The children's sleeping-___ is downstairs.)
