...
|---|---|
| *'i Tonga* | in Tonga |
| *'i Nuku'alofa* | in Nuku'alofa |
| *'i 'api* | at home |
| *'i kolo* | in town |
| *'i siasi* | at church |
| *'i tahi* | at the sea |
| *'i ngoue* | in the plantation |
| *'i mala'e* | on the field |
| *'i hala* | on the road |
...
|---|---|---|
| *heni* | here | near me (the speaker) |
| *hena* | there | near you (the listener) |
| *hē* | over there | wherever the speaker points |
...
*fále* → *falé ni* ("this house")
*fále* → *falé na* ("that house, near you")
...
|---|---|---|
| *Na'á ku fiefia.* | I was happy. | stative (*fiefia*) |
| *Na'á ku 'i kolo.* | I was in town. | location (*'i kolo*) |
...
|--------|----------|---------|
| *'i* | preposition | in, at, on |
| *fē* | question word | where |
...
| *'api* | noun | home |
| *kolo* | noun | town |
| *fale* | noun | house, building |
| *tangutu* | verb | sit down |
| *siasi* | noun | church |
| *tahi* | noun | sea, ocean |
| *ngoue* | noun | plantation, garden |
| *mala'e* | noun | field, village green |
| *hala* | noun | road, path |
...
1. *Na'á ku mohe \_\_\_ fale mohe.* (I slept in the dormitory.)
2. *'Okú ke ngāue \_\_\_?* (Where do you work?)
3. *Tau hiva \_\_\_.* (Let's sing here.)
4. *Té u nofo pē \_\_\_.* (I'll just stay over there.)
5. *Na'á ne nofo \_\_\_ 'api 'aneafi.* (He stayed at home yesterday.)
6. *Na'a mou kai \_\_\_ 'anepō?* (Where did you eat last night?)
