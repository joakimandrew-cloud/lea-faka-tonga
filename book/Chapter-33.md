...
|---|---|
| with, by means of | *fufulu 'aki e vai* (wash with water) |
| of, out of (material) | *ngaohi 'aki 'a e niu* (made of coconut) |
| by, to the extent of | *lahi ange 'aki e ta'u 'e taha* (older by one year) |
...
|---|---|---|---|
| *tokoni* | help (+ *ki*) | *tokoni'i* | help (someone directly) |
| *pule* | be in charge (+ *ki*) | *pule'i* | govern, manage |
| *kole* *(to request)* | request (+ *ki*) | *kole'i* | ask for (something specific) |
| *tā* | hit, strike | *tā'i* | hit (something/someone) |
| *maumau* *(to be broken)* | be broken, wasted | *maumau'i* | break or waste (something) |
...
| *fufulu'i* | verb | wash (transitive) |
| *fakamā'opo'opo* | verb | tidy up |
...
1. *Fufulu \_\_\_ ho falá e vai māfaná.* (with, instrument)
2. *Na'á ku tokoni\_\_\_ 'a Mele.* (helped, transitive)
3. *'Oku mau ngāue\_\_\_ 'ene tohí.* (using)
4. *Na'á ne puke 'a e helé 'o ne tā \_\_\_ e iká.* (with it)
5. *Na'á ku tāpuni\_\_\_ e katō.* (closed completely)
