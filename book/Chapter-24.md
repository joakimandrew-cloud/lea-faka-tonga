...
| Tongan | English |
|---|---|
| *Na'á ku ako peá u foki ki 'api.* | I studied and then went home. |
| *Na'á ku ha'u peá u kamata 'eku ngāué.* | I arrived and then began my work. |
...
> *Note:* You have already seen *'o* in the pattern *lava 'o* (be able to), as in *'Oku ou lava 'o lea* (I can speak). That *'o* is the same conjunction: it connects the ability to the action as a single unit.
...
|---|---|---|
| tense marker | *ka* | *...ka 'oku 'ikai...* |
| pronoun | *ka* | *...ka ke foki...* |
| preposition | *ka* | *...ka 'i kolo...* |
| verb | *kae* | *...kae nofo...* |
| stative | *kae* | *...kae puke...* |
...
> *Note:* You already know *mo* as "with" or "and" when joining nouns (*'a Sione mo Mele*, Sione and Mele). *Mo* can also join adjectives or adverbs: *'Okú ne ngāue mālohi mo lelei* (he works hard and well). The meaning stays the same: "and at the same time."
...
|---|---|---|
| *pea* | and then | Sequential actions |
| *'o* | and (one event) | Actions treated as a single event; time expressions (*'o fuoloa*) |
| *ka* | but | Before tense markers, pronouns, prepositions |
| *kae* | but, while | Before verbs, adjectives, adverbs |
| *pe* | or, whether | Alternatives; indirect questions |
...
|--------|----------|---------|
| *ka* | conjunction | but (before tense markers, pronouns, prepositions) |
| *kae* | conjunction | but, while (before verbs, adjectives, adverbs) |
| *pe* | conjunction | or, whether |

**New vocabulary** (memorize these meanings):

| Tongan | Type | English |
|--------|------|---------|
| *fuoloa* | adjective | long in duration (*'o fuoloa* = for a long time) |
| *'ilo* | verb | know |
