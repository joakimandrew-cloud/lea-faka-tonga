...
|---|---|---|
| *hake* | up | *sio hake* = look up |
| *hifo* | down | *tō hifo* = fall down |
| *holo* | around | *'alu holo* = go around |
...
|---|---|
| *Hanga 'o tāpuni 'a e matapaá.* | Polite |
| *Hanga ange 'o tāpuni 'a e matapaá.* | More polite |
| *Hanga mu'a 'o tāpuni 'a e matapaá.* | More polite |
| *Hanga ange mu'a 'o tāpuni 'a e matapaá.* | Very polite |
...
|--------|----------|---------|
| *atu* | directional particle | away from speaker, toward listener |
| *hifo* | directional particle | downward |
| *holo* | directional particle | around, about |
...
|--------|------|---------|
| *tala* | verb | tell, say |
| *hanga* | verb | turn (polite commands) |
| *tāpuni* | verb | close, shut |
| *fakaava* | verb | open |
| *fufulu* | verb | wash |
| *matapā* | noun | door |
| *fāmili* | noun | family |
