...
|---|---|---|
| Identification | *Ko e fala 'eni.* | This is a mat. |
| Short demonstrative | *Ko'eni.* | Here it is. |
| Short demonstrative | *Ko ē!* | There it is! |
| Question | *Ko e hā ē?* | What is that? |
| Negation | *'Oku 'ikai ko e hele 'eni.* | This is not a knife. |
...
|--------|----------|---------|
| *ko* | identification marker | marks identity (it is, this is) |
| *ko e* | identification + article | it is a/the... |
| *'eni* | demonstrative | this (near me) |
| *'ena* | demonstrative | that (near you) |
| *ē* | demonstrative | that (over there, general) |
| *ko'eni* | fixed demonstrative phrase | here it is |
| *ko ē* | fixed demonstrative phrase | there it is |
| *ko'ena* | fixed demonstrative phrase | there it is (near you) |

**New vocabulary** (memorize these meanings):

| Tongan | Type | English |
|--------|------|---------|
| *ki'i* | modifier | small (before the noun) |
