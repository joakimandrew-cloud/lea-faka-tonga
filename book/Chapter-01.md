...
| | *kai* (eat) | *inu* (drink) | *'alu* (go) | *ha'u* (come) | *mohe* (sleep) | *lea* (speak) | *hiva* (sing) |
|---|---|---|---|---|---|---|---|
| *ku* (I) | *Na'á ku kai.* | *Na'á ku inu.* | *Na'á ku 'alu.* | *Na'á ku ha'u.* | *Na'á ku mohe.* | *Na'á ku lea.* | *Na'á ku hiva.* |
| *ke* (you) | *Na'á ke kai.* | *Na'á ke inu.* | *Na'á ke 'alu.* | *Na'á ke ha'u.* | *Na'á ke mohe.* | *Na'á ke lea.* | *Na'á ke hiva.* |

The same pattern works with the five additional verbs:

| | *nofo* (stay) | *lele* (run) | *ako* (study) | *foki* (return) | *tangi* (cry) |
|---|---|---|---|---|---|
| *ku* (I) | *Na'á ku nofo.* | *Na'á ku lele.* | *Na'á ku ako.* | *Na'á ku foki.* | *Na'á ku tangi.* |
...
|--------|----------|---------|
| *na'a* | past tense marker | marks an action as past |
| *ku* | preposed pronoun: I (after *na'a*) | I |
| *ke* | preposed pronoun: you (after *na'a*) | you |
| *'io* | affirmative response | yes |
| *'ikai* | negative response | no |
...
| *lea* | verb | speak |
| *hiva* | verb | sing |
| *nofo* | verb | stay, sit, live |
| *lele* | verb | run |
| *ako* | verb | study, learn |
...
1. *Na'a \_\_\_ kai.* (I ate.)
2. *Na'a \_\_\_ inu?* (Did you drink?)
3. *Na'a \_\_\_ mohe.* (I slept.)
4. *Na'a \_\_\_ lea?* (Did you speak?)
5. *Na'a \_\_\_ ha'u.* (I came.)
