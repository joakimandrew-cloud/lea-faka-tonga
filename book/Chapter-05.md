...
| you (one) | *ke* | *koe* |
| he, she | *ne* | *ia* |
| we two (incl.) | *ta* | *kitaua* |
| we two (excl.) | *ma* | *kimaua* |
| you two | *mo* | *kimoua* |
| they two | *na* | *kinaua* |
| we (incl.) | *tau* | *kitautolu* |
| we (excl.) | *mau* | *kimautolu* |
| you all | *mou* | *kimoutolu* |
| they | *nau* | *kinautolu* |
...
|--------|----------|---------|
| *'oua* | prohibition marker | don't (in commands) |
| *mu'a* | politeness particle | please |
| *au* | postposed pronoun | I (emphatic) |
| *koe* | postposed pronoun | you (emphatic) |
| *ia* | postposed pronoun | he/she (emphatic) |
| *kitaua* | postposed pronoun | we two inclusive (emphatic) |
| *kimaua* | postposed pronoun | we two exclusive (emphatic) |
| *kimoua* | postposed pronoun | you two (emphatic) |
| *kinaua* | postposed pronoun | they two (emphatic) |
| *kitautolu* | postposed pronoun | we inclusive 3+ (emphatic) |
| *kimautolu* | postposed pronoun | we exclusive 3+ (emphatic) |
| *kimoutolu* | postposed pronoun | you all 3+ (emphatic) |
| *kinautolu* | postposed pronoun | they 3+ (emphatic) |

**New vocabulary** (memorize these meanings):

| Tongan | Type | English |
|--------|------|---------|
| *ō mai* | verb phrase | come (plural of *ha'u*) |
| *fie* | verb prefix | want to |
