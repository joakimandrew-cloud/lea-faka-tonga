...
*Na'e 'uha 'anepō.* It rained last night. (verb, introduced by a tense marker)
:::
...
::: {.examples}
*Na'e lā'ā 'aneafi.* It was sunny yesterday. (Lit. "Was sun yesterday")

*Mahalo 'e matangi.* Perhaps it will be windy.
:::

Words for rank and status work the same way.

::: {.examples}
*'Okú ne 'eiki.* He is a chief.
:::
...
|---|---|---|
| *'uha*, rain | to rain | *Na'e 'uha.*<br><span class="translation">It rained.</span> |
| *lā'ā*, sun | to be sunny | *'Oku lā'ā.*<br><span class="translation">It is sunny.</span> |
| *matangi*, wind | to be windy | *'E matangi.*<br><span class="translation">It will be windy.</span> |
| *tu'i*, king | to be king | *'Okú ne tu'i.*<br><span class="translation">He is king.</span> |
...
|---|---|---|
| *tohi*, to write | book, letter | *Na'á ku lau ha tohi.*<br><span class="translation">I read a book.</span> |
| *hiva*, to sing | song | *Ha hiva lelei.*<br><span class="translation">A good song.</span> |
| *ngāue*, to work | work | *'Okú ne fai e ngāué.*<br><span class="translation">He is doing the work.</span> |
...
Active: *ha me'a ta'ofi*. a brake (Lit. "a thing [that] hinders")
Passive: *'ufi ta'o*. baked yam (Lit. "yam [that has been] baked")

Context determines which reading applies.

| Compound | Meaning |
|---|---|
| *ha tangata tau* | a soldier (a man who fights) |
| *ha loki mohe* | a bedroom (a room for sleeping) |
| *ika tunu* | roasted fish |
| *mā tunu* | toast (toasted bread) |
...
::: {.examples}
*'Okú ne fai ngāue.* He is working. (Lit. "He does work")

*Na'a mau fai lotu.* We prayed. (Lit. "We did prayer")
:::
...
*Ko e 'ai ke u ngāue.* I am getting ready to work.
:::
...
::: {.examples}
*'Oku ngali faingata'a 'a e ngāué.* The work looks difficult.
:::
...
::: {.examples}
*'Oku ngali totonu 'ene ma'u 'a e 'apí.* His getting the home seems right. (Lit. is apparently right his getting the home)

*'Oku ngali fe'unga 'a e me'akaí.* The food looks like enough.
:::

The word *ngali* can also express suitability or fittingness when followed by *mo* (with):

::: {.examples}
*'Oku ngali mo ia ke ne fai pehē.* It is fitting for him to do it that way.
:::

The negative form *ta'e ngali* means "unbecoming" or "not fitting":

::: {.examples}
*'Oku ta'e ngali 'aupito ho'o leá.* Your speech is not becoming at all.

*'Oku ta'e ngali 'a e fuhu 'a e lahí mo e si'í.* It is not fitting for the big one to fight the little one.
:::

> *Note:* In compounds, *ngali tangata* means "manly" or "like a man," and *ngali fefine* means "ladylike" or "like a woman." These function as fixed expressions.
...
::: {.examples}
*'Oku ngalingali 'e 'uha he 'ahó ni.* It looks like it will rain today.
:::

As a verb, *ngalingali* is followed by a full clause:

::: {.examples}
*'Oku ngalingali 'e 'ikai ke lava 'a e ngāué.* It looks like the work will not get done.

*'Oku ngalingali sai ange 'a e fakakaukau ko iá.* That idea seems better.
:::

As a preposed modifier (placed directly before a verb or adjective), it works without a clause:

::: {.examples}
*'Oku ngalingali 'uha he 'ahó ni.* It looks like rain today.

*Na'e ngalingali faingata'a 'a e halá.* The road appeared to be difficult.
:::
...
|--------|----------|---------|
| *ngali* | particle | to seem, to look like |
| *ngalingali* | particle | to seem (tentative, extended form) |

**New vocabulary** (memorize these meanings):

| Tongan | Type | English |
|--------|------|---------|
| *tu'i* | noun/verb | king; to be king |
| *taki* | verb | lead |
...
1. *'Oku \_\_\_ lelei 'a e me'akaí.* The food looks good.
2. *'Oku \_\_\_ 'e 'uha 'apongipongi.* It looks like it will rain tomorrow.
3. *'Oku ta'e \_\_\_ ho'o leá.* Your speech is unbecoming.
4. *'Oku \_\_\_ 'e 'ikai ke ha'u 'a Sione.* It looks like Sione will not come.
5. *'Oku \_\_\_ fe'unga 'a e pa'angá.* The money looks like enough.
6. *Na'e \_\_\_ sai ange 'a e fakakaukau ko iá.* That idea seemed better.
...
5. *'Oku ngalingali 'e 'ikai ke 'osi 'a e ngāué.*
