...
| Base word | With *ta'e-* |
|---|---|
| *fe'unga* *(suitable)* | *ta'e fe'unga* *(unsuitable)* |
| *mahino* *(clear)* | *ta'e mahino* *(unclear, unintelligible)* |
| *totonu* *(correct)* | *ta'e totonu* *(incorrect)* |
| *'ofa* *(loving, kind)* | *ta'e 'ofa* *(unkind)* |
...
| *'Ikai* construction | *ta'e-* construction | Meaning |
|---|---|---|
...
| *'Oku 'ikai ke 'i ai ha faiako heni.* | *'Oku ta'e 'i ai ha faiako heni.* | There is no teacher here. |
...
|---|---|---|
| *ta'e-* + word | un-, not, without | Creates opposite of the following word |
| *'ikai* + *ta'e-* | emphatic positive (double negative) | "It will certainly..." |
| *tala'ehai* | let no one suppose | "Whatever anyone might think, it is not..." |
| *koloto* | not at all | Surprised or disappointed that something expected is absent |
| *ne'ine'i* | no wonder | "It is not surprising that..." |
...
|--------|----------|---------|
| *ta'e-* | negation prefix | un-, not, without |
| *tala'ehai* | particle | let no one suppose, whatever anyone might think |
| *koloto* | adverb | not at all (surprise/disappointment) |
| *ne'ine'i* | particle | no wonder (replaces tense marker) |
| *mole ke mama'o* | idiom | far from it, not at all |

**New vocabulary** (memorize these meanings):

| Tongan | Type | English |
|--------|------|---------|
| *ta'e'aonga* | adjective | useless (from *'aonga*, useful) |
...
| | Tongan | English |
|---|---|---|
| 1 | *ta'e totonu* | a. not at all |
| 2 | *ne'ine'i* | b. let no one suppose |
| 3 | *koloto* | c. no wonder |
| 4 | *tala'ehai* | d. far from it |
| 5 | *mole ke mama'o* | e. incorrect |
| 6 | *ta'e totongi* | f. without pay |
