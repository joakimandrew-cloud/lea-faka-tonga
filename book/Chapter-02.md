...
*Ou* is used after *'oku*.
*U* is used after *kuo* and *te*.
*Ku* remains the past tense form, used after *na'a*.
...
|---|---|---|---|
| I / We (exclusive) | *ku, ou, u* | *ma* | *mau* |
| We (inclusive) | (none) | *ta* | *tau* |
| You | *ke* | *mo* | *mou* |
| He, she, it / They | *ne* | *na* | *nau* |
...
|---|---|---|---|
| I / We (exclusive) | *ku* (past), *ou* (present), *u* (perfect/future) | *ma* | *mau* |
| We (inclusive) | *te* | *ta* | *tau* |
| You | *ke* | *mo* | *mou* |
| He, she, it / They | *ne* | *na* | *nau* |
...
*'okú* before *ke, ne, na, ma, ta, mo*
*kuó* before *u, ke, ne, na, ma, ta, mo*
*na'á* before *ku, ke, ne, na, ma, ta, mo*
*té* before *u, ke, ne, na, ma, ta, mo*
...
*'Okú na lea.* → *'Oku nau lea.*
*Kuó ne kai.* → *Kuo nau kai.*
*Na'á ke mohe.* → *Na'a mou mohe.*
*Té ke kai.* → *Te mou kai.*
...
|--------|----------|---------|
| *'oku* | present tense marker | marks a present action/state |
| *te* | future tense marker | marks a future action |
| *kuo* | perfect tense marker | marks a completed action |
| *ou* | preposed pronoun: I (after *'oku*) | I |
| *u* | preposed pronoun: I (after *kuo, te*) | I |
| *ne* | preposed pronoun: he/she/it | he, she, it |
| *nau* | preposed pronoun: they (3+) | they |
| *mau* | preposed pronoun: we exclusive (3+) | we (not you) |
| *tau* | preposed pronoun: we inclusive (3+) | we (and you) |
| *mou* | preposed pronoun: you (3+) | you all |
| *ma* | preposed pronoun: we two exclusive | we two (not you) |
| *ta* | preposed pronoun: we two inclusive | we two (and you) |
| *mo* | preposed pronoun: you two | you two |
| *na* | preposed pronoun: they two | they two |

**New vocabulary** (memorize these meanings):

| Tongan | Type | English |
|--------|------|---------|
| *ō* | verb | go (plural of *'alu*) |
...
| | |
|---|---|
| 1. *ne* | a. we (inclusive, three+) |
| 2. *mau* | b. you two |
| 3. *tau* | c. they (three+) |
| 4. *mo* | d. he / she / it |
| 5. *nau* | e. we (exclusive, three+) |
| 6. *ta* | f. we two (inclusive) |
| 7. *na* | g. they two |
| 8. *ma* | h. we two (exclusive) |
