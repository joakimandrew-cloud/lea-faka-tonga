...
|---|---|---|
| *kata* (laugh) | *katakata* | to smile (laugh slightly) |
| *kehe* (different) | *kehekehe* | various |
| *kofu* (garment) | *kofukofu* | bundle, parcel |

In some cases the repeated portion shows a vowel change:

| Base word | Reduplicated form | Meaning |
|---|---|---|
| *mu'a* (front, n.) | *mu'omu'a* | to go in front |
| *mafi* (powerful) | *māfimafi* | almighty |
...
| Base word | Reduplicated form | Meaning |
|---|---|---|
| *mata* (face, eye) | *mamata* | to look, to see |
| *fo'ou* (new) | *fo'ofo'ou* | somewhat new, unfamiliar |
| *po'uli* (dark) | *pōpō'uli* | somewhat dark, overcast |
...
| *talinga* (ear) | *talingelinga* | fungus |
...
| Base word | Reduplicated form | Meaning |
|---|---|---|
| *'uli* (dirty) | *'uli'uli* | black |
| *kātoa* (all, whole) | *katokatoa* | absolutely all |
...
| Base word | Reduplicated form | Meaning |
|---|---|---|
| *māfana* (warm) | *māmāfana* | lukewarm |
| *momoko* (cold) | *mokomoko* | cool |
| *kata* (laugh) | *katakata* | smile (laugh slightly) |
| *havili* (strong wind) | *havilivili* | breeze (gentle wind) |
...
| Base word | Reduplicated form | Meaning |
|---|---|---|
| *tapu* (forbidden, sacred) | *toputapu* | sacred (higher register) |
| *taki* (lead by the hand) | *tataki* | guide |
| *moho* (cooked) | *momoho* | ripe |
| *fili* (choose) | *fifili* | ponder, wonder |
| *langa* (build) | *lalanga* | weave |
| *vale* (foolish) | *valevale* | baby (not yet able to think) |
| *fanongo* (listen) | *fanongōnongo* | to announce, publish |
...
|---|---|---|
| *luo* (hole) | *luoluo* | full of holes |
| *va'a* (branch) | *va'ava'a* | branched, branching |
| *toto* (blood) | *totototo* | blood-coloured, red |
...
|---|---|---|
| *pou* (post, pillar) | *poupou* | to support |
| *filo* (thread) | *filofilo* | to spin (make thread) |
| *mata* (face) | *mamata* | to look, to see |

**Adverb → noun:**

| Base adverb | Reduplicated noun | Meaning |
|---|---|---|
| *hake* (up) | *hahake* | the east |
| *hifo* (down) | *hihifo* | the west |
...
|---|---|---|
| *poto* (clever) | *fakapotopoto* | sensible, wise |
| *ala* (to touch) | *fakaalaala* | to be careful, cautious |
| *hanga* (to face) | *fakahangahanga* | to intend |
| *fua* (to measure) | *fakafuofua* | to estimate |
| *ma'u* (to get, be firm) | *fakama'uma'u* | to restrain oneself |
| *'ai* (to place, cause) | *faka'ai'ai* | to incite, encourage |
...
> *Note:* Whether protraction signals superlativeness or duration depends on the word. With adjectives/statives like *lahi* (big) or *si'i* (small), it means extreme degree. With verbs like *nofo* (sit/stay) or *tu'u* (stand), it means prolonged duration.
...
| Tongan | Type | English |
|--------|------|---------|
| *katakata* | verb | chuckle, laugh repeatedly |
| *kehekehe* | adjective | different (various) |
| *mu'omu'a* | adjective | early, in good time |
| *mamata* | verb | look at, watch |
| *pakipaki* | verb | clap |
| *vakavakai* | verb | investigate |
| *toputapu* | adjective | sacred, holy |
| *tataki* | verb | lead, guide |
| *momoho* | adjective | ripe |
| *fifili* | verb | hesitate, be uncertain |
| *fanongōnongo* | verb | listen carefully |
| *valevale* | adjective | confused, foolish |
| *fakapotopoto* | verb | be careful, be wise |
...
1. *poto* (clever) → _____ (meaning: _____)
2. *fua* (measure) → _____ (meaning: _____)
3. *ma'u* (get, be firm) → _____ (meaning: _____)
4. *hanga* (face) → _____ (meaning: _____)
5. *ala* (touch) → _____ (meaning: _____)

#### Exercise 6: Complete reduplication or *faka-* + reduplication?

Fill in the correct form of the word in brackets.

1. *'Oku \_\_\_\_\_ 'a e vaí.* (The water is lukewarm.) [*māfana*]
2. *'Oku \_\_\_\_\_ 'a Sēmisi.* (Sēmisi is wise.) [*poto*]
3. *Na'e \_\_\_\_\_ 'a e halá.* (The road was full of holes.) [*luo*]
4. *Na'á ne \_\_\_\_\_ 'a e me'á.* (He estimated the thing.) [*fua*]
5. *'Oku \_\_\_\_\_ 'a e langi hé.* (The sky over there is black.) [*'uli*]
...
3. *havili* → *havilivili*: partial (later)
4. *kehe* → *kehekehe*: complete
5. *fo'ou* → *fo'ofo'ou*: partial (early)
