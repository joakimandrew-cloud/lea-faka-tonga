...
|---|---|---|
| *'i* | at, in | *'Oku ou nofo 'i Tonga.* I live in Tonga. |
| *ki* | to, toward | *Té u 'alu ki Tonga.* I will go to Tonga. |
| *mei* | from | *Na'á ku ha'u mei Tonga.* I came from Tonga. |
...
| | *'i* (at, in) | *ki* (to) | *mei* (from) |
|---|---|---|---|
| *Tonga* | *'i Tonga* | *ki Tonga* | *mei Tonga* |
| *Nuku'alofa* | *'i Nuku'alofa* | *ki Nuku'alofa* | *mei Nuku'alofa* |
| *'api* | *'i 'api* | *ki 'api* | *mei 'api* |
| *kolo* | *'i kolo* | *ki kolo* | *mei kolo* |
...
::: {.examples}
*Na'á ku ha'u mei Fisi ki Tonga.* — I came from Fiji to Tonga.

*Na'a mau 'alu mei 'api ki kolo 'aneafi.* — We went from home to town yesterday.
:::
...
::: {.examples}
*Na'á ne sio kia Lupe.* — She saw Lupe. (Lit. "She looked to Lupe.")
:::
...
::: {.examples}
*Na'á ku tokoni kiate ia.* — I helped him.
*'Okú ne nofo 'iate au.* — He stays with me.
*Na'á ne ha'u meiate kimautolu.* — He came from us.
:::
...
|---|---|---|---|
| *au* | *kiate au* | *'iate au* | *meiate au* |
| *koe* | *kiate koe* | *'iate koe* | *meiate koe* |
| *ia* | *kiate ia* | *'iate ia* | *meiate ia* |
| *kitautolu* | *kiate kitautolu* | *'iate kitautolu* | *meiate kitautolu* |
| *kimoutolu* | *kiate kimoutolu* | *'iate kimoutolu* | *meiate kimoutolu* |
| *kinautolu* | *kiate kinautolu* | *'iate kinautolu* | *meiate kinautolu* |

The same pattern applies to all postposed pronouns: *kitaua*, *kimaua*, *kimoua*, and *kinaua*.

> *Note:* The *meiate* forms are less common in everyday speech than *kiate* and *'iate*, but they follow the same rule.

The noun type determines the preposition form:

| Noun type | *'i* form | *ki* form | *mei* form | Example |
|---|---|---|---|---|
| **Local** (places) | *'i* | *ki* | *mei* | *ki Tonga* |
...
::: {.examples}
*'Oku mahino kiate au.* — I understand. (Lit. "Is understandable to me.")
:::
...
::: {.examples}
*'Oku mahino kiate koe?* — Do you understand? (Lit. "Is it understandable to you?")

*'Oku mahino kia Siale.* — Siale understands. (Lit. "Is understandable to Siale.")

*'Oku mahino kiate kimautolu.* — We understand.
:::
...
::: {.examples}
*Na'e ngalo 'iate au.* — I forgot. (Lit. "Was forgotten in me.")
:::
...
*Na'e ngalo 'iate kimautolu.* — We forgot.
:::
...
::: {.examples}
*Té ke 'alu ki Vava'u?* — Will you go to Vava'u?
*'Io, té u 'alu ki ai.* — Yes, I will go there.
:::
...
|---|---|---|
| *ki ai* | to there, to him/her | *ki* + place or *kia* + name |
| *'i ai* | there, in it | *'i* + place |
| *mei ai* | from there, from it | *mei* + place |
...
::: {.examples}
*Na'á ke tokoni kia Seini?* — Did you help Seini?
*'Io, na'á ku tokoni ki ai.* — Yes, I helped her.
:::

#### *'I ai*

::: {.examples}
*'Okú ne 'i Tonga?* — Is he in Tonga?
*'Io, 'okú ne 'i ai.* — Yes, he is there.
:::
...
::: {.examples}
*'Oku ou 'i ai.* — I am there.
:::

#### *Mei ai*

::: {.examples}
*Na'á ke ha'u mei Fisi?* — Did you come from Fiji?
*'Io, na'á ku ha'u mei ai.* — Yes, I came from there.
:::

*Mei ai* replaces *mei* + place. Where *mei Fisi* means "from Fiji," *mei ai* means "from there."

::: {.examples}
*Na'a mau 'alu mei ai 'aneafi.* — We left there yesterday.
:::
...
*Na'á ku ha'u pasī.* — I came by bus.
:::
...
| Tongan | English |
|---|---|
| *ha'u vakapuna* | come by plane |
| *'alu loli* | go by truck |
| *ha'u pasī* | come by bus |
| *'alu pasikala* | go by bicycle |
| *folau vaka* | travel by boat |
...
::: {.examples}
*Na'á ne 'alu loli ki kolo.* — He went by truck to town.

*Na'a mau ha'u pasī mei Nuku'alofa.* — We came by bus from Nuku'alofa.
:::
...
| *mei* | preposition | from |
| *kia* | preposition (*ki* + personal noun) | to (before a person's name) |
| *'ia* | preposition (*'i* + personal noun) | at (before a person's name) |
| *meia* | preposition (*mei* + personal noun) | from (before a person's name) |
| *kiate* | preposition (*ki* + pronoun) | to (before a pronoun) |
| *'iate* | preposition (*'i* + pronoun) | at (before a pronoun) |
| *meiate* | preposition (*mei* + pronoun) | from (before a pronoun) |
| *ai* | noun particle | there, it (replaces noun after preposition) |
| *hā* | question word | by what means, how |

**New vocabulary** (memorize these meanings):

| Tongan | Type | English |
|--------|------|---------|
| *sio* | verb | see, look at |
| *fanongo* | verb | listen, hear |
| *'ofa* | verb | love |
| *mahino* | verb | be clear, be understandable |
| *ngalo* | verb | be forgotten |
| *folau* | verb | sail, travel by sea |
| *vaka* | noun | boat |
| *vakapuna* | noun | aeroplane |
| *loli* | noun | truck |
| *pasī* | noun | bus |
| *pasikala* | noun | bicycle |
| *fale mohe* | noun | dormitory |
...
1. *Na'á ku 'alu \_\_\_ Vava'u.*
2. *'Oku mau nofo \_\_\_ 'api.*
3. *Na'á ne ha'u \_\_\_ Fisi.*
4. *Té ke folau \_\_\_ Ha'apai?*
5. *Na'á ku mohe \_\_\_ fale mohe.*
6. *Na'a mau ha'u \_\_\_ kolo.*
7. *Te tau 'alu \_\_\_ tahi.*
...
7. *Na'á ne ha'u \_\_\_ kimautolu.*
8. *Na'á ku lea \_\_\_ ia.*
...
1. *Té ke 'alu ki Vava'u?* → *'Io, té u 'alu \_\_\_.*
2. *'Okú ne 'i Tonga?* → *'Io, 'okú ne \_\_\_.*
3. *Na'á ke ha'u mei Fisi?* → *'Io, na'á ku ha'u \_\_\_.*
4. *Té ke lea kia Mele?* → *'Io, té u lea \_\_\_.*
5. *Na'á ne 'alu mei 'api?* → *'Io, na'á ne 'alu \_\_\_.*
6. *'Okú ke 'i kolo?* → *'Io, 'oku ou \_\_\_.*
