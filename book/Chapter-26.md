...
> *Note:* The obligation patterns *'oku totonu ke* (should) and *kuo pau ke* (must) already use this *ke*. Those patterns are specific cases of subordination: the *ke* clause depends on the main clause for its meaning.
...
| Pattern | Meaning |
|---|---|
| *koe'uhi ke* | in order to, so that |
| *koe'uhi ko* | because of (+ noun or name) |
| *koe'uhi 'oku* | because (+ present clause) |
...
|---|---|---|
| *ma'aku* | *mo'oku* | for me |
| *ma'au* | *mo'ou* | for you (sg.) |
| *ma'ana* | *mo'ona* | for him/her |
| *ma'atau* | *mo'otau* | for us (incl.) |
| *ma'amau* | *mo'omau* | for us (excl.) |
| *ma'amou* | *mo'omou* | for you (pl.) |
| *ma'anau* | *mo'onau* | for them |
...
| *ma'aku* | beneficiary pronoun ('e-class) | for me |
| *ma'au* | beneficiary pronoun ('e-class) | for you |
| *ma'ana* | beneficiary pronoun ('e-class) | for him/her |
| *ma'atau* | beneficiary pronoun ('e-class) | for us (inclusive) |
| *ma'amau* | beneficiary pronoun ('e-class) | for us (exclusive) |
| *ma'amou* | beneficiary pronoun ('e-class) | for you (plural) |
| *ma'anau* | beneficiary pronoun ('e-class) | for them |
| *mo'oku* | beneficiary pronoun (ho-class) | for me |
| *mo'ou* | beneficiary pronoun (ho-class) | for you |
| *mo'ona* | beneficiary pronoun (ho-class) | for him/her |
| *mo'otau* | beneficiary pronoun (ho-class) | for us (inclusive) |
| *mo'onau* | beneficiary pronoun (ho-class) | for them |
...
1. *'Oku ou ha'u \_\_\_ u sio ki he faiakó.*
2. *'Okú ke tōmui, \_\_\_ kuo 'osi hoko.*
3. *Kuo nau ō mai \_\_\_ nau lau 'a e tohí.*
4. *'Oua té ke hiva, \_\_\_ 'okú ne mohe.*
5. *Na'á ku 'alu \_\_\_ u fakatau mai ha ika.*
6. *'Oku nau nofo 'i 'api, \_\_\_ 'oku 'uha.*

#### Exercise 3: Choose *ma'a* or *mo'o*

1. *Ko e ika eni \_\_\_ Mele.* (fish)
2. *'Oku langa e falé \_\_\_ Sione.* (house)
3. *Na'a nau tānaki 'a e pa'angá \_\_\_ e kau tamaikí.* (money)
4. *Ko e ki'i vaka eni \_\_\_ Tēvita.* (boat)
5. *'Ave e valá \_\_\_ Siale.* (clothes)
6. *Ko e tohi eni \_\_\_ Sēmisi.* (book)
