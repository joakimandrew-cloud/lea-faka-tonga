...
|---|---|
| *ha ngaahi fale* | some houses |
| *e ngaahi valá* | the clothes |
| *'eku ngaahi kató* | my baskets |
| *hotau ngaahi valá* | our clothes |
...
|---|---|
| *e kau faiakó* | the teachers |
| *ha kau faifekau* | some ministers |
| *ha kau tangata* | some men |
| *e kau fefiné* | the women |
...
> *Note:* When plurality is already clear from context, the plural marker is often left out. After a numeral (*ha kato 'e nima*, five baskets) or the word *kotoa* *(all)*, the marker is optional because the number already signals more than one.
...
|---|---|---|
| *tamasi'i* | *tamaiki* | child / children |
| *fefine* | *fafine* | woman / women |
| *'eiki* | *hou'eiki* | chief / chiefs |
...
| *'alu* | *ō* | go |
| *ha'u* | *ō mai* | come |
| *tokoto* | *tākoto* | lie down |
| *nofo* | *nonofo* | live together |
...
> *Note:* A few uncommon plural markers exist for specific nouns: *tukui* for places (*tukui fonua*, various countries), *tu'u* for houses, and *hala* for homes. These are rare in modern speech. The four main markers and the dual *ongo* cover nearly all situations.
...
|--------|----------|---------|
| *ngaahi* | plural marker | the (plural, general) |
| *fanga* | plural marker | the (plural, animals) |
| *'ū* | plural marker | the (plural, small group) |
| *ongo* | dual marker | the two, both |
| *kotoa* | quantifier | all |
...
| *faifekau* | noun | minister |
| *puaka* | noun | pig |
| *pulu* | noun | cow |
| *tokoto* | verb | lie down |
| *nonofo* | verb | live together (plural of *nofo*) |
| *lōloa* | adjective | long, tall |
| *iiki* | adjective | small (plural of *si'i*) |
| *lalahi* | adjective | big (plural of *lahi*) |
...
1. *ha \_\_\_ moa* (some chickens)
2. *e \_\_\_ faiakó* (the teachers)
3. *ha \_\_\_ fale* (some houses)
4. *e \_\_\_ tangatá* (the two men)
5. *ha \_\_\_ hele* (some knives)
6. *e \_\_\_ fefiné* (the women)
7. *ha \_\_\_ puaka* (some pigs)
8. *'eku \_\_\_ tohí* (my books)
