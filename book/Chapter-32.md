...
|---|---|---|---|
| *mohe* | sleep | *fakamohe* | put to sleep |
| *lelei* | good | *fakalelei* | mend, repair |
| *totonu* | straight | *fakatotonu* | straighten |
| *fo'ou* (new) | new | *fakafo'ou* | restore, make new |
| *foki* (return) | return | *fakafoki* | send back, return (something) |
...
| Time noun | *faka-* form | Meaning |
|---|---|---|
| *'aho* (day) | *faka'aho* | daily |
| *uike* (week) | *fakauike* | weekly |
...
|--------|----------|---------|
| *faka-* | prefix (manner) | in the manner of, -like, -wise |
| *faka-* | prefix (causative) | to cause, to make |

**New vocabulary** (memorize these meanings):

| Tongan | Type | English |
|--------|------|---------|
| *faka-Tonga* | adverb | in Tongan style |
| *faka-Pālangi* | adverb | in European style |
| *fakalelei* | verb | to fix, to make good |
| *fakatotonu* | verb | to straighten, to correct |
| *fakafo'ou* | verb | to renew |
| *fakamamā* | verb | to lighten, to relieve |
| *fakamālohi* | verb | to strengthen |
| *fakamamafa* | verb | to make heavy, to emphasize |
| *fakamama'o* | verb | to distance |
| *faka'aho* | adverb | daily |
| *fakauike* | adverb | weekly |
| *fakamāhina* | adverb | monthly |
| *fakamaheni* | adjective | familiar, accustomed |
| *faka'atā* | verb | to make free, to open |
| *uike* | noun | week |
| *mama'o* | adjective | far, distant |
| *mamafa* | adjective | heavy |
| *mamā* | adjective | light (weight) |
| *'atā* | adjective | free, clear |
...
1. *'Oku ou hiva \_\_\_.* (in the Tongan way)
2. *Na'á ne \_\_\_ 'ene tamasi'í.* (put to sleep)
3. *'Oku ou lotu \_\_\_.* (daily)
4. *Na'á ku \_\_\_ 'a e falá.* (straightened)
5. *Kuo nau \_\_\_ 'i heni.* (assembled)
