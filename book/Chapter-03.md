...
| Tongan | English |
|---|---|
| *'Oku ou fiekaia.* | I am hungry. |
| *Na'á ku fiekaia.* | I was hungry. |
| *Kuó u fiekaia.* | I have become hungry. |
| *Té u fiekaia.* | I will be hungry. |
...
The nouns here are new: *ika* *(fish)*, *talo* *(taro)*, *vai* *(water)*, *kava* *(kava)*, *tī* *(tea)*.
...
|--------|----------|---------|
| *fa'a* | preposed modifier | often, habitually |
| *'aupito* | postposed intensifier | very, extremely |
| *pē* | postposed limiter | just, only |

**New vocabulary** (memorize these meanings):

| Tongan | Type | English |
|--------|------|---------|
| *fiefia* | adjective | happy |
| *hela'ia* | adjective | tired |
| *fiekaia* | adjective | hungry |
| *fieinua* | adjective | thirsty |
| *'ita* | adjective | angry |
| *vaivai* | adjective | weak |
| *masiva* | adjective | poor |
| *mālohi* | adjective/modifier | strong; hard, strongly |
| *lelei* | modifier | well, good |
| *lahi* | modifier | much, a lot |
| *ngāue* | verb | work |
| *tokoni* | verb | help |
| *mā* | noun | bread |
| *ika* | noun | fish |
...
1. *Na'á ku inu vai \_\_\_.* (I drank only water.)
2. *'Oku ou \_\_\_ hela'ia.* (I am often tired.)
3. *'Okú ne hiva \_\_\_.* (She sings well.)
4. *Na'a mau ngāue \_\_\_.* (We worked hard.)
5. *'Oku ou fiekaia \_\_\_.* (I am very hungry.)
6. *Na'a nau kai \_\_\_.* (They ate a lot.)
