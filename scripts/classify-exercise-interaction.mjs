...
> Auto-generated by \`lea-faka-tonga-app/scripts/classify-exercise-interaction.mjs\` (Phase 1, ${'2026-06-16'}). **PROPOSAL ONLY** — the Phase 2 judge pass corrects the bank + the mcq/reveal call before anything ships. Plan: [[2026-06-16-exercise-interaction-review]].
