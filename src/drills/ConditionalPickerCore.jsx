...
const PROMPTS = [
  { tongan: '___ haʻu ʻa Siale, pea ke tala ki ai.',                 english: 'When Siale comes, tell him. (he is expected)',      answer: 'ka',    why: 'Siale is expected to arrive — the question is when, not whether. ka leans toward the event happening.' },
  ...
  { tongan: '___ ʻi ai ha ngāue, pea ke tala mai.',                  english: 'Whenever there is work, tell me.',                  answer: 'ka',    why: 'A recurring/expected condition — "whenever". ka, not kapau. (ʻi ai is the existential.)' },
