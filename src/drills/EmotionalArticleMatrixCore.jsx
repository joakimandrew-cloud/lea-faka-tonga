...
const EXERCISES = [
  ...
  { english: 'Where are David\u2019s dear children?',                     scenario: 'Specific (David\u2019s) children, with affection.',                                    answer: 'sii', why: 'Definite + emotional (affection / endearment) → siʻi.' },
  { english: 'She had no food. (poor her)',                              scenario: 'Indefinite ("no food at all") + sympathy.',                                            answer: 'sia', why: 'Indefinite + emotional → siʻa. (In a negative existential.)' },
