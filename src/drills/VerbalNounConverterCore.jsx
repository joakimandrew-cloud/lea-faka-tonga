...
const PROMPTS = [
  ...
  { tongan: 'Naʻá ke ngāue ʻi he ngoué. → ʻi ___ ngāue ʻi he ngoué', english: 'when you worked in the garden',     answer: 'hoo',    why: 'Pronoun ke (you sg.) → possessive hoʻo → it stays as he hoʻo. In this course we write only heʻeku and heʻene as one word; the others keep a separate he.' },
  ...
  { tongan: 'Naʻa tau fai ʻa e ngāué. → ʻi ___ fai ʻa e ngāué',      english: 'when we (incl.) did the work',     answer: 'hetau',  why: 'Pronoun tau (we incl.) → possessive ʻetau → it stays as the two words he ʻetau. In this course we write only heʻeku and heʻene as one word; the others keep a separate he.' },
