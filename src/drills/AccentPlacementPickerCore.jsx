...
const PROMPTS = [
  ...
  { tongan: 'ʻOku ou fiemaʻu ha kato.', english: 'I want a basket. (any basket)', answer: 'none', why: 'ha marks an INDEFINITE noun: no particular basket in mind, so no word takes the definitive accent (Lesson 44 Exercise 2; the three levels are taught in Lesson 18).' },
  { tongan: 'Haʻu mo e kató.', english: 'Bring the basket. (the one you know about)', answer: 'kato', why: 'Fully DEFINITE: both of you know which basket, so the accent already shows on the last vowel of the group → e kató (Lesson 18). The semi-definite "Haʻu mo e kato" (a particular basket, not singled out) would stay unaccented.' },
]
