...
const OPTIONS = [
  ...
  { id: 'ko-e-ha-ai',label: 'ko e hā … ai', fill: 'Ko e hā', detail: 'why' },
]
...
const PROMPTS = [
  ...
  { tongan: '___ naʻá ke ʻalu ai ki Nukuʻalofa?',    english: 'Why did you go to Nukuʻalofa?',                 answer: 'ko-e-ha-ai', why: 'ko e hā at the front + ai after the verb = "why?". The ai refers back to the unknown reason.' },
  ...
  { tongan: '___ naʻe ʻita ai?',                     english: 'Why was he angry?',                            answer: 'ko-e-ha-ai', why: 'Same why-pattern: ko e hā + verb + ai.' },
...
export default function KoQuestionPickerCore() {
  return (
    <PickerCore
      options={OPTIONS}
      prompts={PROMPTS}
      question="Which ko-question opener fills the blank?"
