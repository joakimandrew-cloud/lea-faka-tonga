...
export const GROUPS = [
  ...
  },
  {
    ...
    drills: [
      { id: 'tense-swapper', ch: 9, level: 'beginner', title: `Change the tense with one word`, blurb: `Past, present, perfect, future: Tongan swaps a single word, the tense marker, in front of the verb. Practice the swap.`, action: 'Swap',
      ...
      { id: 'aspect-picker', ch: 22, level: 'intermediate', title: `Still, already, not yet`, blurb: `kei, ʻosi, teʻeki ai, lolotonga, toe, toki: pick the aspect marker before the verb that sets the timing.`, action: 'Pick',
