 ...
 *
 * Page chrome around FakaSorterCore. Same structure as PossessiveSorter
 * (the dashboard cards are visually parallel). The Core is shared with
 * the chapter-32 inline anchor via the drill registry.
 */
  ...
  return (
    <div className="pcs-page">
      <header className="pcs-header">
        <div className="pcs-eyebrow">Chapter 32 · Word-Building Drill</div>
        <h1 className="pcs-title">One prefix, four jobs.</h1>
        <p className="pcs-sub">
